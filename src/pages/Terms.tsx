...
export default function Terms() {
  return (
    <>
      <Seo title="Terms of Use — iNRECO" description="The terms that govern your use of the iNRECO Pocket Consultant app, including subscriptions, acceptable use and limits of our guidance." path="/terms" />
