...
const Pricing = () => {
  ...
  return (
    <>
      <Seo title="Pricing — iNRECO Solo & Business plans" description="Simple monthly pricing for iNRECO: the Solo plan for one manager and the Business plan for teams, both with a 7-day free trial." path="/pricing" />
