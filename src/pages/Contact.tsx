...
export default function ContactPage() {
  ...
  return (
    <>
      <Seo title="Contact iNRECO — labour compliance support" description="Send the iNRECO team a message about the Pocket Consultant app, subscriptions, chairperson bookings or South African labour compliance support." path="/contact" />
