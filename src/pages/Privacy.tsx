...
export default function Privacy() {
  return (
    <>
      <Seo title="Privacy Policy — iNRECO" description="How iNRECO collects, uses and protects your personal information under South Africa's POPIA, and the choices you have over your data." path="/privacy" />
